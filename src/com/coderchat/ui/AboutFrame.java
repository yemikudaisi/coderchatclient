...
public class AboutFrame extends javax.swing.JFrame {
    ...
    public AboutFrame() {
        initComponents();
        this.setTitle("About " + Globals.getAppName());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Button.shadow")));

        jLabel1.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        jLabel1.setForeground(java.awt.Color.black);
        jLabel1.setText("About CoderChat");
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        // TODO Close the fomr the right way
        setVisible(false);
        dispose();
